  ...
  return (
    <>
      ...
      <div id="maindiv" className="bg-gray-100 overflow-hidden">
        ...
        <div
          className="mb-4 flex items-center justify-center w-full min-h-screen bg-cover bg-left bg-no-repeat"
          style={{ backgroundImage: `url("/About-img/about-page-img-1.jpg")` }}
        >
